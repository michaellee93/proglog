...
type LogClient interface {
	...
	ProduceStream(ctx context.Context, in *ConsumeRequest, opts ...grpc.CallOption) (Log_ProduceStreamClient, error)
}
...
func (c *logClient) ProduceStream(ctx context.Context, in *ConsumeRequest, opts ...grpc.CallOption) (Log_ProduceStreamClient, error) {
...
type LogServer interface {
	...
	ProduceStream(*ConsumeRequest, Log_ProduceStreamServer) error
...
func (UnimplementedLogServer) ProduceStream(*ConsumeRequest, Log_ProduceStreamServer) error {
